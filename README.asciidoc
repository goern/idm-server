...
playbook by running `ansible-playbook --user=vagrant --private-key=../.vagrant/machines/idm-1/libvirt/private_key --become-user=root --inventory ../inventory.ini site.yml site.yml roles/idm-server/tasks/add_std_roles.yml --tags "init_with_acme"`.
